...
from CUKU.constant import CLASS_NAME,CHROME_DRIVER_LOC,PATH,COLUMN_1,COLUMN_2,COLUMN_3,COLUMN_4,FORMAT
...
def Finding_All_The_Images(Images_needed, driver, starting_length, finished_length, Find_Images):
...
driver,all_images = Finding_All_The_Images(Images_needed, driver, starting_length, finished_length, Find_Images)
...
dataframe.to_html(f"{search_term}_info.html",escape=False,formatters=dict(Images=path_to_image_html))
